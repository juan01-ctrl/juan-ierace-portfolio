...
const Index = () => {
  const automationCursorRef = useRef()
  ...
  const handleMouseMove = (e) => {
    ...
    const child = e.target.querySelector('.icon')

    child.style.transform = `translate(${cursorX}px, ${cursorY}px)`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-muted">
      {/* Hero Section */}
      <section className="px-10 bg-slate-200 md:px-16 pt-32 pb-24 relative h-screen flex justify-center items-center">
        ...
        >
          <img src="/hero-img.png" alt="icon" className="mx-auto" />
          {/* <motion.div variants={itemVariants} className="mb-2">
            <span className="text-lg font-bold text-blue-700 ">Webflow Expert & Full Stack Developer</span>
          </motion.div> */}
          <motion.h1
            variants={itemVariants}
            className="text-4xl text-primary md:text-7xl font-bold mb-6 text-gradient md:leading-snug "
          >
            Juan Ierace <br />
            <span className="md:bg-[#09090af6] rounded-md md:text-white px-2 hero_title-hoverable"
              onMouseMove={handleMouseMove}
              onMouseEnter={handleMouseEnter}
              onMouseLeave={handleMouseLeave}
            >
              Full-Stack Developer
              {/* <div className="web-cursor icon" ref={automationCursorRef}></div> */}
              {/* </span> */}
              {/* {" "} & */}
              {/* <span className="md:bg-[#09090af6] rounded-md md:text-white px-2 hero_title-hoverable"
              onMouseMove={handleMouseMove}
            ...
            > */}
              ...
              {/* <div className="automation-cursor icon" ref={automationCursorRef}></div> */}
            </span>

            {/* <br />Experiences */}
          </motion.h1>
          <motion.p variants={itemVariants} className="text-md md:text-xl text-primary/80 mb-8 font-semibold">
            Building fast, scalable, and efficient web experiences.
          </motion.p>
          <motion.div variants={itemVariants}>
            <a
              href="#work"
              className="inline-flex items-center px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors text-md md:text-xl"
            >
              Explore My Work
            ...
            {[
              {
                ...
                description: "Seamless integration between web platforms, backend services, and business automation tools.",
              },
              {
                icon: Layout,
              ...
              },
              {
                ...
                description: "Enhancing workflows with custom code, third-party integrations, and process automation.",
              },
            ].map((service, index) => (
              <motion.div
                key={index}
      ...
      < section id="work" className="py-24 bg-slate-100" >
        <div className="container">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-primary/60">
              A selection of my best web projects and custom digital solutions.
            </motion.p>
          </motion.div>
      ...
      <footer className="bg-black p-4">
        <div className="flex gap-4 w-full items-center justify-between  container">
          ...
          <div className="flex gap-4">
            <a href="https://www.linkedin.com/company/tech-Juan Ierace" target="_blank" className="hover:-translate-y-1 transition-transform duration-300 ease-out py-2" >
